        ...
        $(function () {
            ...
            $.get("/category/findAll",function (data) {
				...
				for (var i = 0; i < categorys.length; i++){
                    ...
                    var ht = "<option value='" + category.cid + "'>" + category.cname + "</option>";
                    $("#categoryId").append($(ht));
				}
            },"json")
        })
		function cheak() {
            ...
            //alert(goodsName)
            //发送异步请求
            $.post("/goods/findByName", {goods_name: goodsName}, function (data) {
                if (data.flag) {
                    $("#checkName").html(data.errorMsg);
                } else {
                    $("#checkName").html("可以放心使用");
                }
            }, "json")
        }
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" onblur="cheak()" name="goods_name" value="" class="form-control" id="goodsName" placeholder="商品名称">
									</div>
									<div id="checkName">
