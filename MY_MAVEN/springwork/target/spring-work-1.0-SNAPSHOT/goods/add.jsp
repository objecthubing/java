...
<body>
	<div class="container">
		<div class="panel panel-default">
			...
			<!-- 商品添加form表单 -->
			<form action="${pageContext.request.contextPath }/goods/findAll" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="" value="" class="form-control" id="goodsName" placeholder="商品名称">
									</div>
									<div id="checkName">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="" id="categoryId" class="form-control">
											<option>-- 请选择分类 --</option>																
											<option>蔬菜类</option>
											<option>水果类</option>
											<option>肉食类</option> 
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="" value="" class="form-control" id="goodsNumber" placeholder="商品数量">
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="" value="" class="form-control" id="goodsPrice" placeholder="商品价格">
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="control-group">
										...
										<input type="hidden" id="guaranteePeriod" name="" value="" /><br/>
									</div>
								</div>
